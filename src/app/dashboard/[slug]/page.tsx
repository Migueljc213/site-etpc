...
import { FaPlay, FaCheckCircle, FaClock, FaListUl, FaFileVideo } from 'react-icons/fa';
...
export default function CoursePage() {
  ...
  const [watchProgress, setWatchProgress] = useState({ [key: string]: number }(0));
  ...
  const handleVideoTimeUpdate = () => {
    if (videoRef.current && selectedLesson) {
      ...
      setWatchProgress({ [selectedLesson.id]: currentTime });
