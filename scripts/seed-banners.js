...
async function main() {
  ...
  const banners = await prisma.banner.createMany({
    data: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1581092921461-eab62e97a780?w=1200&h=400&fit=crop',
        position: 'homepage-carousel',
        order: 2,
        active: true
      },
      ...
      },
      {
        ...
        description: 'Garante sua vaga nos melhores cursos técnicos da região. Inscreva-se já!',
  ...
  console.log(`Criados ${banners.count} banners de exemplo.`);
}
